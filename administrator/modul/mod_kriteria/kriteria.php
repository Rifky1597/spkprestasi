    ...
    if ($_SESSION[leveluser]=='admin' || $_SESSION['leveluser']=='pendidikan'){
         echo "
		  ...
		  <div class='box box-body box-solid'>
				...
				<div class='box-body'>
						<form method=POST action='$aksi?module=kriteria&act=input_klasifikasi' enctype='multipart/form-data' class='form-horizontal'>
    ...
    if ($_SESSION[leveluser]=='admin' || $_SESSION['leveluser']=='pendidikan'){
        ...
        echo "
		  ...
		  <div class='box box-body box-solid'>
				...
				<div class='box-body'>
						<form method=POST action='$aksi?module=kriteria&act=update_klasifikasi'  class='form-horizontal'>
